---
title: Planner_1_3 Dataview script
kind: script
source: Planner_1_3.md
last_updated: 2025-11-13
---

## Description

Legacy monolithic DataviewJS implementation of the planner, embedding styles, UI construction, logging, agenda management, and consumption flows in a single script. Retained for reference alongside the modular runtime.

---

## Key operations

- Injects CSS and builds the planner UI directly within the DataviewJS block.
- Implements logging, agenda canvas updates, consumption logging, and suggester behavior inline.
- Reads and writes vault files for logs, agenda metadata, canvas JSON, and consumption tables.
...
- Controlled via constants defined inside the script (`MAIN_FOLDER`, `PROJECT_NAME`, etc.).

---

## Input

- In-script constants for paths and settings.
- `app`, `dv`, and `this.container` provided by DataviewJS.

---

## Output

- Renders the planner UI and performs file updates directly within the DataviewJS execution context.

---

## Functions

- Functions are defined inline; see modular equivalents in [`Planner_1_3`](../Planner_1_3.md#code) and related module documentation.

---

## Called by

- DataviewJS block in `Planner_1_3.md` when embedded in an Obsidian note.
